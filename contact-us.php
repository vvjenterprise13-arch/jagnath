...
if ($conn) {
    ...
    $email_data = get_cached_query_result($conn, $contact_email_sql, null, []);
    if (!empty($email_data)) {
    ...
    $phone_data = get_cached_query_result($conn, $contact_phone_sql, null, []);
    if (!empty($phone_data)) {
    ...
    $address_data = get_cached_query_result($conn, $full_address_sql, null, []);
