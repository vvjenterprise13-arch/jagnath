...
<div class="main-container">
    ...
    <main>
        <section class="shipping-content">
            ...
            <p>At <?php echo $brandName; ?>, we are committed to delivering your products in a timely and efficient manner.</p>
            ...
            <p>Orders are typically processed within <strong>1-3 business days</strong> (Monday to Friday, excluding public holidays) after payment confirmation.</p>
            ...
            <p>Once your order is shipped, you will receive an email with a tracking number to track your package.</p>

            <h2>6. Shipping Address</h2>
            <p>Please ensure your shipping address is accurate. We are not responsible for delays due to incorrect address information.</p>

            <h2>7. Damage During Transit</h2>
            <p>If you receive a damaged product, contact us within 24-48 hours with photos. We will arrange a replacement or refund.</p>

            <h2>8. Contact Us</h2>
            <p>For questions about our Shipping Policy, please <a href="/contact-us">contact us</a>.</p>
        </section>
    </main>
</div>
