...
<div class="main-container">
    ...
    <main>
        <section class="policy-content">
            ...
            <p>This Privacy Policy describes how <?php echo $brandName; ?> collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from our Site.</p>

            <h2>1. Information We Collect</h2>
            <ul>
                <li><strong>Personal Information:</strong> Name, email address, mailing address, phone number, and payment information.</li>
                <li><strong>Order Information:</strong> Products purchased, shipping address, billing address, and contact details.</li>
                <li><strong>Usage Data:</strong> IP address, browser type, pages viewed, time spent on pages.</li>
                <li><strong>Cookies and Tracking Technologies:</strong> We use cookies to track activity on our Services.</li>
            </ul>

            <h2>2. How We Use Your Information</h2>
            <ul>
                <li>Process your orders and manage your account.</li>
                <li>Communicate with you about orders, products, and promotional offers.</li>
            ...
            <p>We do not sell your personal information. We may share it with service providers (payment processing, shipping), during business transfers, or when required by law.</p>

            <h2>4. Cookies</h2>
            <p>We use cookies to enhance your browsing experience. You can choose to refuse cookies in your browser settings, though some parts of the Service may not function properly.</p>

            <h2>5. Security</h2>
            <p>We use commercially acceptable means to protect your data, but no method of transmission over the Internet is 100% secure.</p>
