...
if ($conn) {
    ...
    $settings_data = get_cached_query_result($conn, $settings_sql, null, []); // 1 day cache
...
$all_categories_data = get_cached_query_result($conn, $categories_sql, null, []); // 1 hour cache
$all_categories = [];
